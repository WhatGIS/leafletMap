...
* */
/**
 * 更改了leftLayer 和 rightLayer 获取 Container 的方法，如果是Layer的话，就是获取Container，LayerGroud和 FeatureGroup 是获取Pane
 * zhangjie.20200527
 */
...
L.Control.SideBySide = L.Control.extend({
  ...
  remove: function () {
    ...
    if (this._leftLayer) {
      this._leftLayer.getPane().style.clip = '' //zhangjie 20200527
    }
    if (this._rightLayer) {
      this._rightLayer.getPane().style.clip = '' //zhangjie 20200527
    }
    this._removeEvents()
  ...
  _updateClip: function () {
    ...
    if (this._leftLayer) {
      //this._leftLayer.getContainer().style.clip = clipLeft; //zhangjie 20200527
      this._leftLayer.getPane().style.clip = clipRight;
    }
    if (this._rightLayer) {
      //this._rightLayer.getContainer().style.clip = clipRight //zhangjie 20200527
